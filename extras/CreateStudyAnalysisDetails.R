...
createAnalysesDetails <- function(workFolder) {
  ...
  ####Wrap up####
  cmAnalysisList <- list(#a11, #"On-treatment, PS overlap weighting" old version
    a12, #"On-treatment, one-to-one matching"
    a13, #"On-treatment, variable-ratio matching"
    a14, #"On-treatment, stratification"
    a15, #"On-treatment, IPTW"
    a16, #"On-treatment, Without matching"
    a17, #"On-treatment, PS overlap weighting within equipoise"
    a18, #"On-treatment, IPTW within equipoise",
    a31, #"ITT, PS overlap weighting" old version
    a32, #"ITT, one-to-one matching"
    a33, #"ITT, variable-ratio matching",
    a34, #"ITT, stratification"
    a35, #"ITT, IPTW"
    a36, #"ITT, Without matching"
    a37, #"ITT, PS overlap weighting within equipoise"
    a38) #"ITT, IPTW within equipoise"
